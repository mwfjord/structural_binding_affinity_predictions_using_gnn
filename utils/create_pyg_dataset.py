...
if __name__ == "__main__":
    ...
    # Save datasets as lists of Data objects instead of the entire Dataset class
    torch.save([data for data in train_dataset], "./train_dataset.pt")
    torch.save([data for data in val_dataset], "./val_dataset.pt")
    torch.save([data for data in test_dataset], "./test_dataset.pt")
